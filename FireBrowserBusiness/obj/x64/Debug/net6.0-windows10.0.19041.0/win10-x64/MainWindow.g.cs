...
namespace FireBrowserBusiness
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IMainWindow_Bindings
        {
            ...
            private static bool isobj33FlyoutDisabled = false;
            private static bool isobj35FlyoutDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                {
                    isobj33FlyoutDisabled = true;
                }
                else if (lineNumber == 394 && columnNumber == 43)
                {
                    isobj35FlyoutDisabled = true;
                }
            ...
            private void Update_FavoritesFly(global::Microsoft.UI.Xaml.Controls.Flyout obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    ...
                    if (!isobj33FlyoutDisabled)
                    {
                        XamlBindingSetters.Set_Microsoft_UI_Xaml_Controls_Button_Flyout(this.obj33, obj, null);
                    }
                }
            }
            private void Update_HistoryFlyoutMenu(global::Microsoft.UI.Xaml.Controls.Flyout obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    ...
                    if (!isobj35FlyoutDisabled)
                    {
                        XamlBindingSetters.Set_Microsoft_UI_Xaml_Controls_Button_Flyout(this.obj35, obj, null);
                    }
                }
            }
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 28: // MainWindow.xaml line 42
                ...
                break;
            case 29: // MainWindow.xaml line 242
                {
            ...
            case 33: // MainWindow.xaml line 392
                ...
                break;
            case 34: // MainWindow.xaml line 393
                {
            ...
            case 36: // MainWindow.xaml line 395
                ...
                break;
            case 37: // MainWindow.xaml line 382
                {
